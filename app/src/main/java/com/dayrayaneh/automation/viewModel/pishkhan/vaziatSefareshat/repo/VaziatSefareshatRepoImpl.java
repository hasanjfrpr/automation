...
public class VaziatSefareshatRepoImpl implements VaziatSefareshatRepo{

    private ApiService apiService = ApiInstance.getApiInstance();
    private JsonObject jsonObject = new JsonObject();

    @Override
    public Single<VaziatSefareshatModel> getVaziatSefareshat(String startDate, String endDate) {

        jsonObject.addProperty("startDate" , startDate+" 00:00:00.000");
        jsonObject.addProperty("endDate" , endDate+" 23:59:59.000");

        return apiService.getVaziatSefareshat(jsonObject);
    }
}
